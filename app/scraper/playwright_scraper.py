...
# from playwright_stealth import stealth  # disabled: playwright-stealth's Stealth() class needs pkg_resources, which isn't installed in this env
...
def scrape_city(district: str, main_cat: str, subcat: str, max_limit=10, fast_mode=False, start_page=1, browser_type="chrome"):
    ...
    try:
        with sync_playwright() as p:
            ...
            pass  # stealth mode disabled (see import comment above)
