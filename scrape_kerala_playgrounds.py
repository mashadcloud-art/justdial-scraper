...
logger = logging.getLogger("kerala_playgrounds_scraper")
...
# Playground, Sports Ground, Turf, and related physical activity categories
categories = [
    "Sports Ground",
    "Playgrounds",
    "Turf Grounds",
...
logger.info("🏟️ Starting batch JustDial scrape for Kerala Playgrounds, Sports Grounds, and Turfs...")
    ...
    for idx, district in enumerate(districts_to_scrape):
        ...
        try:
            inserted, updated = scrape_jwt_city(
                district=district,
                category=category,
                pages=5, # Scrape 5 pages per pincode/location
                limit=10,
                dry_run=False,
                subcategories=False,
...
logger.info("\nPlaygrounds batch scrape completed!")
